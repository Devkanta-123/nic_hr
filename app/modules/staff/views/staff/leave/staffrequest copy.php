                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="card-title">
                                <strong>Staff Leave request</strong>
                            </div>
                                                ...
                                                <div class="card-body">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-3 col-md-3 col-lg-3 ">
                                                            ...
                                                            <!-- <label>isUrgent</label>
                                                            <input class="bootstrapToggle" type="checkbox" id="isUrgent" checked data-toggle="toggle" data-on="Urgent" data-off="Not Urgent" data-onstyle="success" data-offstyle="light" data-width="100%"> -->
                                                        </div>
...
<script>
    ...
    async function saveAddFormData() {
        ...
        json.FromDate = convertDateFormat(fromDateInput);
        json.ToDate = convertDateFormat(toDateInput);
