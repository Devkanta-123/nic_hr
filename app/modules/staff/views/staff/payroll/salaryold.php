                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <span class="float-right">
                                <button class="btn btn-success btn-xs" data-toggle="modal" data-target="#modal-lg"> <i class="fa fa-circle-thin"> <i class="fa fa-plus"></i> </i> Staff Salary</button>
                            </span>
                        </div>
                            ...
                            <div class="modal-dialog modal-xs">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h4 class="modal-title">Staff Salary</h4>
                                    ...
                                    <div class="modal-body">
                                        <div class="card-body text-center">
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label for="net_salary">Net Amount</label>
                                                        <input type="number" id="net_salary" class="form-control" placeholder="Net Amount" autocomplete="off">
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="date" id="salarydate" class="form-control" value="<?php echo date('Y-m-d') ?>">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="modal-footer justify-content-between">
                                        ...
                                        <button type="button" class="btn btn-primary btn-xs" id="btnAddStaffSalary">Save </button>
                                    </div>
                                </div>
                                <!-- /.modal-content -->
                            </div>
...
<script>
    ...
    function loaddata(data) {
        ...
        if (data.length == 0) {
            ...
            for (let i = 0; i < data.length; i++) {
                ...
                text += '<td> ' + data[i].NetSalary + '</td>';
                text += '<td> ' + data[i].Earning + '</td>';
                text += '<td style="color:red;"> ' + data[i].Deduction + '</td>';
                text += '<td style="color:green;"> ' + data[i].SalaryDate + '</td>';
                // text += '<td>';
    ...
    $("#btnAddStaffSalary").click(function() {
        debugger;
        let obj = {};
        obj.Module = "Staff";
        ...
        json.NetSalary = $("#net_salary").val();
        json.Earning = $("#earning").val();
        json.Deduction = $("#deduction").val();
        json.SalaryDate = $("#salarydate").val();
        obj.JSON = json;
        if ($("#net_salary").val() == '' || $("#earning").val() == '' || $("#deduction").val() == '') {
