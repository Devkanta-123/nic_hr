                    ...
                    <div class="card">
                        <div class="card-header">
                            <span class="float-right">
                                <button class="btn btn-success btn-xs" data-toggle="modal" data-target="#modal-lg"> <i class="fa fa-circle-thin"> <i class="fa fa-plus"></i> </i>New Training Type</button>
                            </span>
                        </div>
                            ...
                            <div class="modal-dialog modal-xs">
                                <div class="modal-content">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" id="training_name" class="form-control" placeholder="Training Type Name" autocomplete="off">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="modal-footer justify-content-between">
                                        ...
                                        <button type="button" class="btn btn-primary btn-xs" id="btnAddTrainingType">Save </button>
                                    </div>
                                </div>
                                <!-- /.modal-content -->
                            </div>
...
<script>
    ...
    $("#btnAddTrainingType").click(function() {
        debugger;
        let obj = {};
        obj.Module = "Settings";
        obj.Page_key = "addTrainingTypes";
        let json = {};
        json.TrainingType = $("#training_name").val();
        obj.JSON = json;
        TransportCall(obj);
    });
</script>