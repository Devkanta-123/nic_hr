                            ...
                            <form id="#">
                                <div class="row">
                                    <div class="form-group col-md-4">
                                        ...
                                        <input type="text" class="form-control" id="typesofpayment"
                                            name="typesofpayment" placeholder="Types Of Payment" required>
                                    </div>
                                    <div class="form-group col-md-4">
