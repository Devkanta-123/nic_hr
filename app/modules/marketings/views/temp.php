					...
					<div class="card">
						<div class="card-header">
							...
							<div class="card-title">
								<strong>Notice in School Letter Head</strong>
							</div>
							<span class="float-right">
								<button class="btn btn btn-warning" onclick="resetForm();" data-toggle="modal" data-target="#mdlAdd"><i class="fa fa-plus"></i>&nbsp;<strong>Create notice in school letter head</strong></button>
							</span>
													...
													<div class="row">
														...
														<div class="col-sm-12 col-md-12 col-lg-12">
															<div class="form-group">
																...
																<textarea class="textarea" name="description" id="description" autocomplete="off"></textarea>
															</div>
														</div>
														...
														<div class="col-sm-12 col-md-4 col-lg-4">
															...
															<select class="form-control select2" id="applicable" data-placeholder="-Select-" style="width: 100%;" required>
...
<script>
	...
	{
		if (!$("#description").val() || $("#description").val()=="" || $('#description').val()=="<p><br></p>") {
			notify('error', 'Description missing !!');
			return false;
		}
	...
	function loaddata(data) {
		...
		if (data.length > 0) {
			for (let i = 0; i < data.length; i++) {
				...
				var action = '<button class="btn btn-xs btn-info" data-toggle="modal" data-target="#mdlView" data-notice_id="' + data[i].NoticeID + '" data-title="' + data[i].Title + '" data-sdate="' + data[i].StartDate + '" data-edate="' + data[i].EndDate + '"><i class="fa fa-eye"></i>&nbsp;<strong>VIEW</strong></button>';
				if (data[i].ShortLink) {
					action += '<a href=' + data[i].ShortLink + ' class="btn btn-xs btn-info m-1" title="OPEN LINK" target="_blank"><i class="fas fa-eye"></i>&nbsp;SHORT LINK</a>';
				}
				text += '<tr>';
